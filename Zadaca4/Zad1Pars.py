    ...
    def _readLabels(self):
        for (line, n) in self._lines:
            ...
            if len(l) == 2 and l[0].strip() == "label":
                if l[1].strip() in self._labels:
                    Parser._error("Label", n, "Duplicate label.")
                    return ""
                
                self._labels.append(l[1].strip())
        return True
    ...
    def _parseLine(self, line, n):
        ...
        if l[0] == "push":
            ...
            if l[0] == "label" and len(l) == 2:
                ...
                if l[1].strip() not in self._labels:
                    Parser._error("Label", n, "Invalid label.")
                    return ""
                return "//" + " ".join(l) + "\n" + self._goto(l[1], n)
